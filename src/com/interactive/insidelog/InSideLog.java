...
public class InSideLog extends Application {
    ...
    private void initVBoxInformation() {
        ...
        HBox hboxInteractive = new HBox();
        hboxInteractive.alignmentProperty().setValue(Pos.CENTER);
        hboxInteractive.getChildren().add(linkInteractive);
        hboxInteractive.getChildren().add(labelYear);
